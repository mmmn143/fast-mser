...
namespace basicimg {
	...
	*/
	...
	Note that an MSER algorithm can degenerate to an ER algorithm by the following settings: 
	m_delta = 0, ER
	...
	*/
	...
	public:
		...
		*/
		...
		/** Clear memory cache
		When an MSER algorithm detects MSERs in an image, it needs to allocate memory for some data-structures.
